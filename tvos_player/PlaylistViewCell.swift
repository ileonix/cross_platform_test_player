...
class PlaylistViewCell: UITableViewCell {
    ...
    func setupView()  {
        ...
        self.playlistItemView.topAnchor.constraint(equalTo: self.contentView.topAnchor).isActive = true
        ...
        self.playlistItemView.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor).isActive = true
    }
