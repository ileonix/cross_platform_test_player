//
//  BBTVPlayeriOSCloseVideoView.swift
//  BBTVPlayeriOS
//
//  Created by Chanon Purananunak on 30/4/2563 BE.
//
//
...
public class BBTVPlayeriOSCloseVideoView: UIView {
public var videoView: UIView?
    ...
    public func setUpUI() {
        imageView?.image = self.loadImageBundle(named: "Back")
    }
